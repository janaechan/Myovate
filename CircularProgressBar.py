...
class CircularProgressBar(ProgressBar):
    ...
    def draw(self):
        ...
        with self.canvas:
            ...
            Ellipse(pos=(self.pos[0] - self.size[0]/2, self.pos[1] - self.size[1]/2), size=self.size)
            ...
            Color(0, 0, 0)
            Ellipse(pos=(self.pos[0] + self.thickness / 2 - (self.size[0]/2), self.pos[1] + self.thickness / 2 - (self.size[1]/2)),
